...
export const skills = [
  {
    name: 'JavaScript',
    description: 'The language behind almost everything I build — from the Boss Mode front end to the autonomous control code I wrote on the robotics team.',
  },
  {
    name: 'Python',
    description: 'Used for scripting and data work, going back to the summer certification course that got me into programming in the first place.',
  },
  {
    name: 'C++',
    description: 'Learned through more traditional coursework — the language that taught me how memory and performance actually work under the hood.',
  },
  {
    name: 'React',
    description: "My go-to for building interfaces — component-based and reusable. It's what powers Bit Of Logic's reporting platform and the Boss Mode site.",
  },
  {
    name: 'Mongoose',
    description: 'The ODM I use to model and query MongoDB data in Node backends — keeps schema logic clean and predictable.',
  },
  {
    name: 'HTML / CSS',
    description: 'The foundation — every layout, every responsive breakpoint, every pixel of the sites I\u2019ve shipped starts here.',
  },
  {
    name: 'SQL',
    description: "Used to query and structure the centralized database behind Bit Of Logic's engine test-stand reporting platform.",
  },
  {
    name: 'REST APIs',
    description: 'How my front ends talk to my back ends — designing and consuming them to move data cleanly between systems.',
  },
  {
    name: 'System Design',
    description: 'Thinking through how the pieces of an app fit together before writing a line of code — data flow, architecture, tradeoffs.',
  },
  {
    name: 'Agile',
    description: 'The way my teams have shipped — iterative sprints, regular check-ins, adjusting scope as requirements evolve.',
  },
  {
    name: 'Git / GitHub',
    description: 'Version control for everything I build — branching, PRs, and the pipelines that ship code straight to production.',
  },
  {
    name: 'Cloudflare Pages',
    description: 'Where Boss Mode lives — connected straight to GitHub so every push deploys automatically, no build step needed.',
  },
]
